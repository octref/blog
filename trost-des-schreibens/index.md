...
My writing establishes a domain for my thoughts. Although the domain is nebular, ideas come into shape when thoughts connect as patterns, much like constellations. I have wondered if linearity in writing tools has made it impossible for certain ideas to form, or if book is inadequate for certain ideas to per-form. For example, in the domain of programming, graph is as fundamental as line. Ideas of this shape are minority in the domain of books, but there are elegant manifestations as well, such as the *The Garden of Forking Paths* by Borges.
...
I have wondered why I, and so many other people, keep coming back to HN. One reason might be that although many of us do a day-job for paychecks, our intellectual curiosity, like a cat, often leads us astray. Kafka worked at an insurance company and wrote on his spare time. The less obvious reason is Arc, the lisp-inspired language Paul wrote for building HN. I have wondered why it is so hard to point to any specific thing I like about HN. Then one day I realized that HN is likable because of its likeness to a language, consisting of bare elements that retain structures for expressions and of nothing more. The vacancy allows it to be filled with intellectually curious ideas.
