...
When inspecting DOM, I still need to go back to Chrome DevTools. But I find myself debugging much faster when using VSCode, which I use everyday for coding.
